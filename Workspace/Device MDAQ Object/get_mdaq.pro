	function get_mdaq, file, error=error
;
;	Read in a Jamie LabVIEW TMS export MDAQ file for run details.
...
;	scan: origin:x,y, size(mm):x_mm,y_mm, pixels:x_pixels,y_pixels
    ...
    scan = {on:0, x_pixels:0, y_pixels:0, x:0.0, y:0.0, x_mm:0.0, y_mm:0.0, $
          mode:0, n_steps:0, step_size:0.0, sort_mode:0, dwell:0.0, use_ylut:0, $
...
err:
	warning, 'get_mdaq', ['Serious error in MDAQ file.','Ignoring MDAQ file settings.']
	goto, more
	end
