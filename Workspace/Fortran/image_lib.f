...
! ensure integer arguments to iand() and ior() match in "kind" for gfortran
...
data pa_tag_tf5 /z'F0000000'/, tf_tag_mask5 /z'FC000000'/
...
data data_type_mask /z'F0000000'/
...
data pa_tag_tf4 /z'F8000000'/, tf_tag_mask4 /z'FE000000'/, tf_tag_fc1 /z'FA000000'/
...
INTEGER*2 de, dt, dx, dy, adr, dtag, pa_tag4
INTEGER*2 pa_offset4, de_offset4, dt_offset4, pdf_offset4, tag_offset4, adr_offset4
...
data pa_tag_tf4 /z'F0000000'/, tf_tag_mask4 /z'FC000000'/, tf_tag_fc1 /z'F4000000'/
...
data RTCmask /z'1000'/, DummyMask /z'8000'/
data sync /z'FFFF'/
...
data correct_mdx /z'8000'/, correct_mdy /z'4000'/
