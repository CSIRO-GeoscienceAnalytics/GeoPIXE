function read_spring8_37U_header, unit, error=error
...
if catch_errors_on then begin
    ...
    if (ErrorNo ne 0) then begin
       ...
       warning,'read_spring8_37U_header',['IDL run-time error caught.', '', $
...
error = 1
	...
	if err then begin
		warning,'read_spring8_37U_header','Failed to read XML file.'
		goto, finish
	endif
