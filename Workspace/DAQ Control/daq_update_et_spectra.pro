pro daq_update_ET_spectra, pstate, update=update, error=error
...
;	                   0           1         2    3    4    5    6    7  ...   13
	...
	if catch_errors_on then begin
	    ...
	    if (ErrorNo ne 0) then begin
	       ...
	       warning,'daq_update_ET_spectra',['IDL run-time error caught.', '', $
...
; records. Later will use activity data from klee.
