...
pro flatten_to_elastic_image_plugin, p, ii, title=title, history=history

COMPILE_OPT STRICTARR

if arg_present(title) then begin
	title = '* Flatten to elastic Image Plugin'		; return the menu title for this plugin
...
bad_element:
	warning,'flatten_to_elastic_image_plugin','Could not find "elastic".'
	return
end
