...
pro flatten_to_flux1_image_plugin, p, ii, title=title, history=history

COMPILE_OPT STRICTARR

if arg_present(title) then begin
	title = '* Flatten to Flux1 Image Plugin'		; return the menu title for this plugin
...
q = where( el_name eq 'Flux1', nq)			; flatten based on "Flux1" image
if nq eq 0 then goto, bad_element

base = 0.05									; ignore pixels where flux1 is less than
...
; No need to add the plugin name here; this is done by GeoPIXE.
	...
	history = 'Flatten to "Flux1" plugin'
	return

;...............................................................................................

bad_element:
	warning,'flatten_to_flux1_image_plugin','Could not find "Flux1".'
	return
end
