...
pro Image_Process, GROUP_LEADER=wGroup, TLB=Image_Process_TLB, plugins=plugins, $
          ...
          pimage=pimage, _EXTRA=_VWBExtra_
...
;      ]
  ...
  routine = [ $
	 ...
	 'Image_Process_Zeroes', $
	 'Image_Process_correct_Y_ripples']

;       'Image_Process_Suppress_Region', $ ; 22
;       'Image_Process_Shift', $     ; 23
;       'Image_Process_Shift', $     ; 24
;       'Image_Process_Shift', $     ; 25
;       'Image_Process_Shift', $     ; 26
;       'Image_Process_Shift', $     ; 27
;       'Image_Process_Shift', $     ; 28
