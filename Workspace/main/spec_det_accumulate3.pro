function spec_det_accumulate3, e,x,y,ste,pu,veto,n, spec,ns,nd,found, nnpu,nn, mask,nx,ny, $
								multiple=multiple
;
...
if catch_errors_on then begin
	...
	if (ErrorNo ne 0) then begin
		...
		warning,'spec_det_accumulate3',['IDL run-time error caught.', '', $
...
err = call_external( geopixe_library(), geolib_name( 'spec_det_accumulate3'), cdecl=geolib_cdecl(), $
...
bad:
	print,' spec_det_accumulate3: Error - bad type for argument.'
	err = 1L
	return, err
end
