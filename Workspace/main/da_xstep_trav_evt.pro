pro da_xstep_trav_evt, filei, matrix, xrange=xrange, charge=charge, $
...
bad_matrix:
    warning, 'da_xstep_trav_evt', 'Bad DA matrix.'
    goto, cleanup

bad_file:
    warning, 'da_xstep_trav_evt', 'EVT file not found.'
    goto, cleanup

bad_obj:
	warning, 'da_xstep_trav_evt', 'Bad device object for: '+device
    goto, cleanup
end
