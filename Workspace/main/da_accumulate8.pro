function da_accumulate8, x,y,e,pu,veto,n,good, image,nx,ny,nel2, nnpu,nn, image_error,nxe,nye, $
...
if catch_errors_on then begin
	...
	if (ErrorNo ne 0) then begin
		...
		warning,'da_accumulate8',['IDL run-time error caught.', '', $
...
err = call_external( geopixe_library(), geolib_name( 'da_accumulate8'), cdecl=geolib_cdecl(), $
		...
		long(compress>1), multiple, value=value )

return, err

bad:
	gprint,' da_accumulate8: Error - bad type for argument: '+sb
	err = 1L
	return, err
bad_array:
	gprint,' da_accumulate8: Error - array dimensions for argument: '+sb
	err = 1L
	return, err
end
