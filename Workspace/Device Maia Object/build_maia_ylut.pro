function build_maia_ylut, file, output=output, slow_axis=slow_axis, error=error
...
if catch_errors_on then begin
    ...
    if (ErrorNo ne 0) then begin
       ...
       warning,'build_maia_ylut',['IDL run-time error caught.', '', $
...
write_maia_ylut, ylut, file[0], output=output, /strip, error=error
