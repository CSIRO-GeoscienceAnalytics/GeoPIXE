pro delete_maia_ylut, file, output=output, error=error
...
if catch_errors_on then begin
    ...
    if (ErrorNo ne 0) then begin
       ...
       warning,'delete_maia_ylut',['IDL run-time error caught.', '', $
...
bad_del:
	warning,'delete_maia_ylut','error deleting Y lookup table.',/error
	return
end
