pro maia_accumulate_dtfx_3D, t,x,y,z,ste,veto,fx,n,n_fx, flux_mode, flux_scale, xrange,yrange,zrange, $
...
if catch_errors_on then begin
	...
	if (ErrorNo ne 0) then begin
		...
		warning,'maia_accumulate_dtfx_3D',['IDL run-time error caught.', '', $
...
err = call_external( geopixe_library(), geolib_name( 'maia_accumulate_dtfx_3d'), cdecl=geolib_cdecl(), $
...
if err then gprint,' maia_accumulate_dtfx_3D: Error in Fortran - bad number of arguments'
return

bad:
	gprint,' maia_accumulate_dtfx_3D: Error - bad type for argument: '+sb
	err = 1L
	return
end
