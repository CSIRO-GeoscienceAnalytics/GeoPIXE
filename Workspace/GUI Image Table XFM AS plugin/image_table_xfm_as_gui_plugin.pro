...
function image_table_xfm_as_gui_plugin_event, Event
...
if catch_errors_on then begin
	...
	if (ErrorNo ne 0) then begin
		...
		warning,'image_table_xfm_as_gui_plugin_event',['IDL run-time error caught.', '', $
	...
	case uname of
		'XFM_Button': begin
			...
			OnButton_Image_Table_Export_XFM_AS, Event
			end
...
bad_state:
	warning,'image_table_xfm_as_gui_plugin_event',['STATE variable has become ill-defined.','Abort Image Table.'],/error
	goto, finish
bad_ptr:
	warning,'image_table_xfm_as_gui_plugin_event',['Parameter structure variable has become ill-defined.','Abort Image Table.'],/error
	goto, finish
end

;-----------------------------------------------------------------

pro OnButton_Image_Table_Export_XFM_AS, Event
...
function image_table_xfm_as_gui_plugin, tab_panel, pstate_parent
...
; ---------------- xfm  -------------------------------------------------------------------
	...
	WIDGET_CONTROL, xfm_base, EVENT_FUNC = 'image_table_xfm_as_gui_plugin_event'
