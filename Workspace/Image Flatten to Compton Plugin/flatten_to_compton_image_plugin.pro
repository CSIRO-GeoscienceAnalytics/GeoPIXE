...
pro flatten_to_compton_image_plugin, p, ii, title=title, history=history

COMPILE_OPT STRICTARR

if arg_present(title) then begin
	title = '* Flatten to Compton Image Plugin'		; return the menu title for this plugin
...
q = where( el_name eq 'Compton', nq)		; flatten based on "Compton" image
if nq eq 0 then goto, bad_element

base = 0.05									; ignore pixels where Compton is less than
											; this fraction of average
											
scale =  flux_flatten( (*pimg)[*,*,q[0]], base=base)
...
; No need to add the plugin name here; this is done by GeoPIXE.
	...
	history = 'Flatten to "Compton" plugin'
	return

;...............................................................................................

bad_element:
	warning,'flatten_to_compton_image_plugin','Could not find "Compton".'
	return
end
